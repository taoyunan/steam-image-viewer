...
-   **左侧快速导航**：新增固定导航菜单，可一键跳转到横幅、基础数据、配置、宣传影像、图片探查器和链接导出区域。
-   **基础数据增强**：补充开发商、发行商、官网、价格、平台、分类、发布日期、PC 配置等常用信息。
...
-   **接口容错优化**：SteamCMD、商店、玩家人数、评测等接口部分失败时，页面会尽量继续展示已成功获取的数据。
...
-   **丰富信息**: 全面展示来自两大 API 的关键数据，现在包含：
    ...
    -   PC 配置要求 (最低与推荐)
    -   游戏官网、标签、分类
    -   开发商、发行商、官网、价格、平台、分类、发布日期
    -   宣传影像与 HLS / MPEG-DASH 视频流
...
4.  **快速跳转**: 使用左侧导航菜单，一键跳转到“基础”“配置”“视频”“图片”“链接”等区域。
...
8.  **查看数据**: 如果需要，可以点击“查看 API 数据”按钮来深入了解游戏的详细信息。
